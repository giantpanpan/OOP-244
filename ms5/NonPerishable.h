...
namespace sict
{
	...
	public:
		...
		NonPerishable(const char* sku, const char* name, const char* unit, const int quantityC=0, const bool taxornot =true, const double price_o =0, const int quantityN=0);
